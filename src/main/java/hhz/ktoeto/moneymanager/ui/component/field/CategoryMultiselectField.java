...
public class CategoryMultiselectField extends AbstractFieldWithAction<Set<Category>, MultiSelectComboBox<Category>> {

    public CategoryMultiselectField() {
        super(new MultiSelectComboBox<>("Категории"), MaterialIcons.ADD);
