package hhz.ktoeto.moneymanager.backend.user_domain.validation;

import hhz.ktoeto.moneymanager.backend.user_domain.exception.InvalidRegisterRequestException;
